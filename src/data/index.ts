...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    image: '/img/projects/inzpiri.png',
  },
  {
    title: 'WiZRX',
    description:
  ...
  },
  {
    ...
    image: '/img/projects/smart-pricer.png',
  },
  {
    title: 'SEEYOU',
  ...
  },
  {
    ...
    technologies: ['Nodejs', 'CI/CD', 'Semver', 'Typescript', 'NPM', 'Git', 'Github'],
    live: 'https://www.npmjs.com/package/strongly-typed-env',
    image: '/img/projects/env.png',
  },
  {
    title: 'CDN Checker',
    description:
    ...
    technologies: ['Nodejs', 'Typescript', 'VSCE', 'Git', 'Github'],
    live: 'https://marketplace.visualstudio.com/items?itemName=AliBarznji.cdn-checker',
    image: '/img/projects/cdn-checker.png',
  },
  {
    title: 'SEEYOU Chat',
  ...
  },
  {
    ...
    technologies: ['.NET', 'C#', 'SQL Server', 'SQL', 'OOP'],
  },
  {
    title: 'Grades App',
    description:
      'A Grades platform for highschool graduates to easily pick the best university for them based on their grades and preferences',
    technologies: ['.NET', 'C#', 'SQL Server', 'SQL', 'OOP', 'SQLITE'],
  },
]
...
export const experience: IExperience[] = [
  ...
  },
  {
    ...
    description:
      'Developed and maintained the backend of the SEEYOU chat platform using RabbitMQ, Redis, and scalable messaging architecture. Built Slack and Telegram integration demos for real-time messaging. Led backend proxy development for Smart Pricer, enhancing API performance. Recognized twice as Employee of the Month and selected for DCH’s elite "Navy SEAL" team for top-tier performance, innovation, and work ethic. Integrated real-time communication with Node.js and third-party APIs.',
  },
]
...
export const achievements: IAchievement[] = [
  {
    ...
    year: '2019',
    description:
      'Recognized for exceptional critical thinking and creative problem-solving skills.',
  },
  {
    title: 'Adaptability',
    issuer: 'Global Solutions',
...
export const skills: ISkill[] = [
  ...
  { name: 'Elixir', level: 40, category: 'Languages' },

  // Frameworks (Top 5)
  { name: 'React', level: 90, category: 'Frameworks' },
  { name: 'Vue', level: 90, category: 'Frameworks' },
  { name: 'Next', level: 80, category: 'Frameworks' },
  ...
  { name: 'RabbitMQ', level: 60, category: 'Databases' },
]
...
export const funFacts: IFunFact[] = [
  {
    ...
    title: 'Early Leader',
    description:
      'Became a team leader at 22, guiding projects and people before most even finished grad school.',
  ...
  },
  {
    ...
    description:
      'Deeply moved by classical music—especially Chopin’s nocturnes, which never fail to inspire focus and calm.',
  ...
  },
  {
    ...
    description:
      'Travels at least once every year to experience new cultures, cuisines, and perspectives.',
  ...
  },
  {
    ...
    title: 'Global Circle',
    description:
      'Has friends scattered across many countries, making every trip feel like visiting family.',
  ...
  },
  {
    ...
    description:
      'Avid reader of philosophy and literature, with Dostoevsky being a constant source of reflection.',
  ...
  },
  {
    ...
    description:
      'Prefers games with rich narratives that feel like interactive novels rather than just challenges.',
  ...
  },
  {
    ...
    description:
      'Comfortably works across multiple projects without being tied to a single tech stack.',
