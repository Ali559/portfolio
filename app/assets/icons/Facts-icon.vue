<template>
  ...
  >
    ...
    <path
      ...
      fill="#C778DD"
      mask="url(#path-17-inside-1_52_1850)"
    />
    <mask
      id="path-19-outside-2_52_1850"
      ...
      fill="black"
    >
      <rect fill="white" x="64" y="83.2501" width="59" height="87" />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M65 84.2501H93.25H121.5V112.5H93.25V140.75H121.5V169H93.25H65V140.75V112.5V84.2501Z"
      />
    </mask>
    <path
      d="M65 84.2501V83.2501H64V84.2501H65ZM121.5 84.2501H122.5V83.2501H121.5V84.2501ZM121.5 112.5V113.5H122.5V112.5H121.5ZM93.25 112.5V111.5H92.25V112.5H93.25ZM93.25 140.75H92.25V141.75H93.25V140.75ZM121.5 140.75H122.5V139.75H121.5V140.75ZM121.5 169V170H122.5V169H121.5ZM65 169H64V170H65V169ZM93.25 83.2501H65V85.2501H93.25V83.2501ZM121.5 83.2501H93.25V85.2501H121.5V83.2501ZM122.5 112.5V84.2501H120.5V112.5H122.5ZM93.25 113.5H121.5V111.5H93.25V113.5ZM94.25 140.75V112.5H92.25V140.75H94.25ZM93.25 141.75H121.5V139.75H93.25V141.75ZM120.5 140.75V169H122.5V140.75H120.5ZM121.5 168H93.25V170H121.5V168ZM65 170H93.25V168H65V170ZM64 140.75V169H66V140.75H64ZM64 112.5V140.75H66V112.5H64ZM64 84.2501V112.5H66V84.2501H64Z"
      fill="#C778DD"
      mask="url(#path-19-outside-2_52_1850)"
    />
  </svg>
</template>
